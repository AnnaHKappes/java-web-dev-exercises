...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Peach", .10, new ArrayList<>(Arrays.asList("none")), 9);
        Topping topping2 = new Topping("Mango", .20, new ArrayList<>(Arrays.asList("none")), 10);
        Topping topping3 = new Topping("Kiwi", .30, new ArrayList<>(Arrays.asList("none")), 8);
